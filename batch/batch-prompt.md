...
**Cross-cutting edge**: Frame the profile as a **"Technical builder"** who adapts their framing to the role:
...
2. **"Sell senior without lying" plan**: specific phrasings, concrete achievements, founder as an advantage
3. **"If they downlevel me" plan**: accept if comp is fair, 6-month review, clear criteria

#### Block D — Comp and Demand

Use WebSearch for current salaries (Glassdoor, Levels.fyi, Blind), company comp reputation, demand trend. Table with data and sources cited. If there is no data, say so.
...
4. Detect company location → paper format: US/Canada → `letter`, else → `a4`
...
- Reframe real experience with the exact vocabulary from the JD
